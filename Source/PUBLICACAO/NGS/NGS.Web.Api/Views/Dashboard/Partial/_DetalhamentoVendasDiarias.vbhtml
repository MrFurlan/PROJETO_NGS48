...
<h2>Detalhes de Vendas Diárias</h2>

<table id="tabelaVendasDiarias" class="table table-bordered table-striped" style="width: 100%;">
    <thead>
        <tr>
            <th>Data</th>
            <th>Pedido</th>
...
<script>
    $(document).ready(function () {
        ...
        $('#tabelaVendasDiarias').DataTable({
            "responsive": true,
            "lengthChange": true,
            "autoWidth": false,
            "pageLength": 10,
            "order": [[0, "desc"]], // Coluna 0 = Data
            "language": {
