...
<Serializable()> _
Public Class ListProcedimentoParaProducao
    Inherits List(Of ProcedimentoParaProducao)
    ...
    Public Sub New(ByVal CarregarDados As Boolean)
        If CarregarDados Then
            Dim sql As String = "Select Codigo_Id, Descricao, isnull(Ativo,0) as Ativo From ProcedimentoDeProducao"
            Dim Banco As New AcessaBanco
            Dim ds As DataSet

            ds = Banco.ConsultaDataSet(sql, "ProcedimentoDeProducao")
            For Each row As DataRow In ds.Tables(0).Rows
                Dim Cr As New ProcedimentoParaProducao
...
<Serializable()> _
Public Class ProcedimentoParaProducao
...
#Region "Contrutor"
    ...
    Public Sub New(ByVal pCodigo As Integer)
        ...
        ds = Banco.ConsultaDataSet("Select Codigo_Id, Descricao, isnull(Ativo,0) as Ativo From ProcedimentoDeProducao Where Codigo_Id = " & pCodigo, "ProcedimentoDeProducao")
...
#Region "Methods"
    ...
    Public Sub SalvarSql(ByRef Sqls As ArrayList)
        ...
        Select Case Me.IUD
            Case "I"
                Sql = " INSERT INTO ProcedimentoDeProducao (Descricao, Ativo, UsuarioInclusao, UsuarioInclusaoData) " & vbCrLf & _
                      " VALUES ('" & _Descricao & "','" & _Ativo.ToString() & "','" & HttpContext.Current.Session("ssNomeUsuario") & "',getdate())"
                Sqls.Add(Sql)
            Case "U"
                Sql = " UPDATE ProcedimentoDeProducao SET" & vbCrLf & _
