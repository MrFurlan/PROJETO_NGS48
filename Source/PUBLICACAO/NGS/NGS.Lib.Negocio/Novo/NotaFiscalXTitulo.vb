...
#Region "Contrutor"
        Public Sub New(pNotaFiscal As NotaFiscal)
            ...
            For Each row As DataRow In ds.Tables(0).Rows
                Dim NxT As New Novo.NotaFiscalXTitulo(pNotaFiscal, New Novo.TituloNovo(row("Titulo_Id")))
                Me.Add(NxT)
            Next
        End Sub
#End Region
...
#Region "Construtor"
        ...
        Public Sub New(pNota As NotaFiscal, pTitulo As Novo.TituloNovo)
            _Titulo = pTitulo
            _NotaFiscal = pNota
        End Sub

        'Retorna a nota ligada ao titulo se houver
        Public Sub New(pTitulo As Novo.TituloNovo)
            Dim sql As String
