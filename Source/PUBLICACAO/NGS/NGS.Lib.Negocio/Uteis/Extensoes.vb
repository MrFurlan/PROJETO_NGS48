...
Module Extensoes
    ...
    <Extension()> _
    Public Function ToSqlNULL(ByVal pData As Date) As String
        If Not IsDate(pData) Then
            Return "NULL"
        Else : Return "'" & pData.ToString("yyyy-MM-dd") & "'"
        End If
    End Function

    <Extension()> _
    Public Function ToSqlNULL(ByVal pstr As String) As String
        If pstr Is Nothing OrElse Len(pstr) = 0 Then
            Return "NULL"
        Else : Return "'" & pstr & "'"
        End If
    End Function
    ...
    <Extension()> _
    Public Function ToSql(ByVal pBol As Boolean) As String
        Return "'" & pBol.ToString & "'"
    End Function
    ...
    <System.Runtime.CompilerServices.Extension()> _
    Public Function ToSqlDateNULL(ByVal pDate As Date) As String
