<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="CentrosDeCustos.aspx.vb" Inherits="NGS.Web.UI.CentrosDeCustos" %>
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        function pageLoadCentroDeCusto() {
            $('#MainContent_GridCentroDeCusto').DataTable({
                stateSave: true,
                "language": {
            ...
            $("#resultado").click(function () {
                $.ajax({
                    type: "POST",
                    url: "/CentrosDeCustos.aspx/MeuMetodo",
        ...
        $(document).ready(function () {
            pageLoadCentroDeCusto();

            var prmCentroDeCusto = Sys.WebForms.PageRequestManager.getInstance();
            prmCentroDeCusto.add_endRequest(pageLoadCentroDeCusto);
        });
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngCentrosDeCustos" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlCentrosDeCustos" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" TabIndex="1" runat="server" Width="100px" data-ToolTip="default"
                        ToolTip="Código de cadastro do centro de custo." />
                </div>
                <div class="collbl">
                    Ativo:
                </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" TabIndex="2" runat="server" Width="500px" data-ToolTip="default"
                        ToolTip="Descrição do centro de custo." />
                </div>
            </div>
            <asp:GridView ID="GridCentroDeCusto" runat="server" AutoGenerateColumns="False" OnPreRender="GridCentrosDeCustos_PreRender"
                CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridCentrosDeCustos_SelectedIndexChanged">
