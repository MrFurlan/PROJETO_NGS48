<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="RelatorioSinteticoDeFretes.aspx.vb" Inherits="NGS.Web.UI.RelatorioSinteticoDeFretes" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngRelatorioSinteticoDeFretes" runat="server" EnableScriptGlobalization="True"
        EnableScriptLocalization="True" AsyncPostBackTimeout="5000" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlRelatorioSinteticoDeFretes" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="HID" runat="server" />
            <div class="titulodiv">
                Relatório Sintético de Fretes
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:RadioButton ID="rbPorCliente" runat="server" AutoPostBack="true" Checked="true"
                        GroupName="TipoRelatorio" Text="Por Cliente" data-ToolTip="default" ToolTip="Selecionar se o relatório será por cliente ou transportador." />
                </div>
                <div class="coltxt">
                    <asp:RadioButton ID="rbPorTransportador" runat="server" AutoPostBack="true" GroupName="TipoRelatorio"
                        Text="Por Transportador" data-ToolTip="default" ToolTip="Selecionar se o relatório será por cliente ou transportador." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:CheckBox ID="chkFinalizados" Text="Pedidos Finalizados" runat="server" />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div id="divTipoDePeriodo" class="coltxt" runat="server">
                    <div class="coltxt">
                        <asp:TextBox ID="txtDataDe" runat="server" Style="width: 80px;" CssClass="calendario" data-ToolTip="default"
                            ToolTip="Informar a data inicial e fnal da consulta." />
                        &nbsp; à &nbsp
                    <asp:TextBox ID="txtDataAte" runat="server" Style="width: 80px;" CssClass="calendario" data-ToolTip="default"
                        ToolTip="Informar a data inicial e fnal da consulta." />
                    </div>
                    <div class="coltxt">
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    ...
                    <asp:RadioButton ID="rdoFinanceiroNao" runat="server" GroupName="grpFinanceiro" Text="Não"
                        AutoPostBack="true" Checked="True" data-ToolTip="default" ToolTip="Informar se é para ser considerado ou não apenas o financeiro." />
                </div>
            </div>
            <div class="row">
                <div class="collbl" style="width: 170px;">
