<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucConsultaEmpresas.ascx.vb"
    Inherits="NGS.Web.UI.ucConsultaEmpresas" %>
...
<div id="divConsultaEmpresas" class="uc" title="Consulta de Empresas" style="display: none;">
