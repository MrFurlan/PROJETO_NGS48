<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucEmailNFe.ascx.vb"
    Inherits="NGS.Web.UI.ucEmailNFe" %>
<script type="text/javascript">
    function pageLoadEmailNFe() {
        $("#MainContent_ucEmailNFe_btnEnviar", "#divEmailNFe").button();
        $("#MainContent_ucEmailNFe_btnFechar", "#divEmailNFe").button();

        $("#MainContent_ucEmailNFe_txtMensagem", "#divEmailNFe").keydown(function (e) {
            if (e.keyCode == 13) {
                e.preventDefault();
                return false;
            }
    ...
    var prmEmailNFe = Sys.WebForms.PageRequestManager.getInstance();
    prmEmailNFe.add_endRequest(pageLoadEmailNFe);
</script>
<div id="divEmailNFe" class="uc" title="Envio de e-mail" style="display: none;">
    <asp:UpdatePanel ID="updpnlEmailNFe" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:CheckBox ID="chkCompactado" runat="server" Text="Compactar anexos?" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
