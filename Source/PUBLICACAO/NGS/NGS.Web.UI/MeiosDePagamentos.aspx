<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="MeiosDePagamentos.aspx.vb" Inherits="NGS.Web.UI.MeiosDePagamentos" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngMeiosDePagamentos" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlMeiosDePagamentos" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Meios de Pagamentos
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" runat="server" Width="100px" data-ToolTip="default" ToolTip="Código do Meio de Pagamento." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" runat="server" Width="500px" MaxLength="80" data-ToolTip="default"
                        ToolTip="Descrição do Meio de Pagamento." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    ...
                    <asp:RadioButton ID="RadNao" runat="server" Text="Não" GroupName="Ativos" data-ToolTip="default"
                        ToolTip="Informar se o Meio de Pagamento está ativo ou não." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="GridMeiosDePagamentos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridMeiosDePagamentos_SelectedIndexChanged">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="UsuarioInclusao" HeaderText="Usuario Lan">
                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Left" Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="UsuarioInclusaoData" HeaderText="Usuario Lan.Data">
                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Left" Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="UsuarioAlteracao" HeaderText="Usuario Alt">
                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Left" Width="80px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="UsuarioAlteracaoData" HeaderText="Usuario Alt.Data">
                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Left" Width="80px"></ItemStyle>
                        </asp:BoundField>
                    </Columns>
