...
Partial Public Class ConsistenciaDeLotes

    '''<summary>
    '''Controle scrmngConsistenciaDeLotes.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents scrmngConsistenciaDeLotes As Global.System.Web.UI.ScriptManager
    ...
    '''<summary>
    '''Controle updpnlConsistenciaDeLotes.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents updpnlConsistenciaDeLotes As Global.System.Web.UI.UpdatePanel

    '''<summary>
    '''Controle LinkConsultar.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents LinkConsultar As Global.System.Web.UI.WebControls.LinkButton
    ...
    '''<summary>
    '''Controle gridConsistenciaDeLotes.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents gridConsistenciaDeLotes As Global.System.Web.UI.WebControls.GridView
End Class
