<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="AnalisadorDeDeposito.aspx.vb" Inherits="NGS.Web.UI.AnalisadorDeDeposito" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updpnlAnalisadorDeDeposito" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Analisador de Depósito
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:DropDownList ID="ddlUnidade" ToolTip="Unidade de negócio empresarial." runat="server" Width="634px" OnSelectedIndexChanged="DdlUnidade_SelectedIndexChanged"
                        AutoPostBack="True" />
                </div>
            </div>
            <div class="row">
