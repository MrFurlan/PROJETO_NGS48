<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="Responsabilidades.aspx.vb" Inherits="NGS.Web.UI.Responsabilidades" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmResponsabilidades" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlResponsabilidades" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Responsabilidades
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" TabIndex="1" runat="server" Width="100px" data-ToolTip="default"
                        ToolTip="Código de cadastro da responsabilidade." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" TabIndex="2" runat="server" Width="500px" data-ToolTip="default"
                        ToolTip="Descrição da responsabilidade." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="GridResponsabilidades" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridResponsabilidades_SelectedIndexChanged">
