<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="CategoriaDaPraga.aspx.vb" Inherits="NGS.Web.UI.CategoriaDaPraga" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmngCategoriaDaPraga" runat="server">
    </asp:ScriptManager>
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlCategoriaDaPraga" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Categoria da Praga
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" runat="server" data-ToolTip="default"
                        ToolTip="Número de cadastro da praga." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" runat="server" Width="500px"
                        data-ToolTip="default" ToolTip="Descrição do tipo de praga." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="gridCategoriaDaPraga" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="gridCategoriaDaPraga_SelectedIndexChanged">
