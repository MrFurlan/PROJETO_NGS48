<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="PesagemDaOrdemDeCarregamento.aspx.vb" Inherits="NGS.Web.UI.PesagemDaOrdemDeCarregamento" %>
            ...
            $("#MainContent_TabContainer1_TabPanel1_txtSegundaPesagem").keydown(function (e) {
                if (e.keyCode == 13) {
                    ...
                    if ($("#MainContent_TabContainer1_TabPanel1_txtSegundaPesagem").val() != "" && $("#MainContent_TabContainer1_TabPanel1_txtSegundaPesagem").val() != undefined && parseInt($("#MainContent_TabContainer1_TabPanel1_txtSegundaPesagem").val()) > 0) {
                        ...
                        $("#MainContent_TabContainer1_TabPanel1_txtObservacao").focus();

                        //$("#btnAutorizacao").click();
                        //$("##MainContent_TabContainer1_TabPanel1_btnAu    torizacao").click();
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmngsPesagemDaOrdemDeCarregamento" runat="server" AsyncPostBackTimeout="10000" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlPesagemDaOrdemDeCarregamento" runat="server">
        <ContentTemplate>
                    ...
                    <ContentTemplate>
                        <div style="float: left; width: 50%">
                            ...
                            <div style="width: 100%; padding: 10px 10px 10px 10px">
                                ...
                                <asp:Button ID="btnReimprimir" runat="server" CssClass="botao" Enabled="True" Text="Reimprimir"
                                    UseSubmitBehavior="False" />
                            </div>
                        </div>
                        <div style="float: right; width: 50%">
                            ...
                            <div style="width: 100%;">
                                <fieldset class="borda_pontilhado">
                                    <legend class="fonte6"><strong><em>PESAGEM</em></strong></legend>
                                    <%--<label class="titulo">
