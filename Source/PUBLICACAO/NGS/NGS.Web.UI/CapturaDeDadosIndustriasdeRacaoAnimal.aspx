<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="CapturaDeDadosIndustriasdeRacaoAnimal.aspx.vb" Inherits="NGS.Web.UI.CapturaDeDadosIndustriasdeRacaoAnimal" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmngCapturaDeDados" runat="server" AsyncPostBackTimeout="360000" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlCapturaDeDados" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Captura de Dados - Industrias de Ração Animal
            </div>
