<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="GruposXProcessos.aspx.vb" Inherits="NGS.Web.UI.GruposXProcessos" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngGruposXProcessos" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlGruposXProcessos" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Grupos X Processos
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:DropDownList ID="DdlProcessos" TabIndex="4" runat="server" Width="550px" />
                </div>
            </div>
            <div class="bordagrid">
