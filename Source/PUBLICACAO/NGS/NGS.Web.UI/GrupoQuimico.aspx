<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="GrupoQuimico.aspx.vb" Inherits="NGS.Web.UI.GrupoQuimico" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmngGrupoQuimico" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlGrupoQuimico" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Grupo Químico
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" runat="server" Enabled="False" data-ToolTip="default"
                        ToolTip="Número de cadastro do grupo químico." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" runat="server" Width="500px"
                        data-ToolTip="default" ToolTip="Descrição do grupo químico." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="gridGrupoQuimico" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="gridGrupoQuimico_SelectedIndexChanged">
