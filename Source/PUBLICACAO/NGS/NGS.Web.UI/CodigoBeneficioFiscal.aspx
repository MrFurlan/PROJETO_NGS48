<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="CodigoBeneficioFiscal.aspx.vb" Inherits="NGS.Web.UI.CodigoBeneficioFiscal" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngCodigoBeneficioFiscal" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlCodigoBeneficioFiscal" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" runat="server" CssClass="txtNumerico" Width="100px" ToolTip="Informar código com 6 caracteres ou 8 se for SC, inclusive 0(zero) a esquerda se necessário. Ex.: 000001 OR 00000001." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" runat="server" Width="500px" data-ToolTip="default"
                        ToolTip="Descrição da observação fiscal." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="gridAjustesDaApuracaoIcms" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="gridAjustesDaApuracaoIcms_SelectedIndexChanged">
