...
Public Class PedidosPendentesDeVendas
    Inherits BasePage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack And IsConnect Then
                If Funcoes.VerificaPermissao("PedidosPendentesDeVendas", "ACESSAR") Then
                    CargaUnidade()
                    VerificaUnidade()
                    CargaMes()
                    CargaAno()
        ...
        Try
            ...
            If Mensagem = "" Then
                ...
                If RadCliente.Checked = True Then
                    ...
                    Sql = "SELECT Consulta.Pedido_Id AS Pedido, PedidosConsulta.DataPedido AS Data, Clientes.Nome AS Cliente, Clientes.Bairro, Clientes.Cidade, Clientes.Estado, " & vbCrLf & _
                          ...
                          "               SUM(CASE" & vbCrLf & _
                          "                     WHEN isnull(NotasFiscaisXItens.EntradaSaida_Id, 'S') = 'S'" & vbCrLf & _
                          ...
                          "           AND pxi.Produto_Id    = NotasFiscaisXItens.Produto_Id" & vbCrLf

                    Sql &= " WHERE      (Pedidos.DataPedido BETWEEN '2010-01-01' AND '2015-12-31') AND (SubOperacoes.EntradaSaida = 'S') AND (Pedidos.Situacao = 1)"
                ...
                Else
                    Sql = "SELECT Consulta.Pedido_Id AS Pedido, PedidosConsulta.DataPedido AS Data, Clientes.Nome AS Cliente, Produto_Id as Produto, Unidade, NomeDoProduto, " & vbCrLf & _
                          ...
                          "                       ELSE ISNULL(NotasFiscaisXItens.Valor, 0)" & vbCrLf & _
                          "                   END) AS ValorNota," & vbCrLf & _
                          "               Produtos.Produto_Id, Produtos.Unidade, Produtos.Nome AS NomeDoProduto, " & vbCrLf & _
                          ...
                          "           AND (SubOperacoes.EntradaSaida = 'S')" & vbCrLf & _
                    ...
                    If ucSelecaoProduto.TemSelecionado Then
                        ...
                        Sql &= " AND " & RetornoProdutos(0) & vbCrLf
                    End If
    ...
    Protected Sub lnkAjuda_Click(sender As Object, e As EventArgs) Handles lnkAjuda.Click
        Try
            Funcoes.Ajuda(Me.Page, "PedidosPendentesDeVendas")
        Catch ex As Exception
