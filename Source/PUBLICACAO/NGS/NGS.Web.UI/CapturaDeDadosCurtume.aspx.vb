...
Public Class CapturaDeDadosCurtume
    Inherits BasePage
            ...
            If Validar() Then
                Try
                    ...
                    For Mes As Integer = DdlMesInicial.SelectedValue To DdlMesFinal.SelectedValue
                        ...
                        If Not Left(Empresa(0), 8) = "05272759" AndAlso Not Left(Empresa(0), 8) = "05366261" AndAlso Not Left(Empresa(0), 8) = "38198213" AndAlso Not Left(Empresa(0), 8) = "40938762" AndAlso Not Left(Empresa(0), 8) = "44005444" AndAlso Not Left(Empresa(0), 8) = "62747840" AndAlso Not Left(Empresa(0), 8) = "62780383" AndAlso Not Left(Empresa(0), 8) = "63358210" Then
                            '****************************************************************************************
                        ...
                        If Left(Empresa(0), 8) = "05272759" OrElse Left(Empresa(0), 8) = "05366261" OrElse Left(Empresa(0), 8) = "38198213" OrElse Left(Empresa(0), 8) = "40938762" OrElse Left(Empresa(0), 8) = "44005444" OrElse Left(Empresa(0), 8) = "03189063" OrElse Left(Empresa(0), 8) = "62747840" OrElse Left(Empresa(0), 8) = "62780383" OrElse Left(Empresa(0), 8) = "63358210" Then
                            ...
                            '    '****************************************************************************************
                            If Left(Empresa(0), 8) = "05272759" Then
                                erroAux = CapturaCustosIndiretosAntigo(Mes)
                            Else
    ...
    Private Function CapturaCustosIndiretosAntigo(ByVal pMes As Integer) As Boolean
        ...
        If Left(Empresa(0), 8) = "05366261" OrElse Left(Empresa(0), 8) = "38198213" OrElse Left(Empresa(0), 8) = "40938762" OrElse Left(Empresa(0), 8) = "44005444" OrElse Left(Empresa(0), 8) = "62747840" OrElse Left(Empresa(0), 8) = "62780383" OrElse Left(Empresa(0), 8) = "63358210" Then 'Nutri/NutriLog/Baxi/Fronteira
            sql = "SELECT n.Empresa_Id, n.EndEmpresa_Id, n.Deposito AS Deposito_Id, n.EndDeposito AS EndDeposito_Id, NI.Produto_id," & vbCrLf &
                    ...
                    "WHERE n.Empresa_Id like '" & Left(Empresa(0), 8) & "%'" & vbCrLf &
    ...
    Private Function CapturaEstoques(ByVal pMes As Integer) As Boolean
        ...
        If ds2 IsNot Nothing AndAlso ds2.Tables IsNot Nothing AndAlso ds2.Tables.Count > 0 AndAlso ds2.Tables(0).Rows.Count > 0 Then
            For Each rs As DataRow In ds2.Tables(0).Rows
                ...
                If (Left(Empresa(0), 8) = "05366261" OrElse Left(Empresa(0), 8) = "38198213" OrElse Left(Empresa(0), 8) = "40938762" OrElse Left(Empresa(0), 8) = "44005444" OrElse Left(Empresa(0), 8) = "62747840" OrElse Left(Empresa(0), 8) = "62780383" OrElse Left(Empresa(0), 8) = "63358210") AndAlso rs("Produto_Id") = "102010003" Then
    ...
    Private Sub ContabilizaCurtume(ByVal pMes As Integer)
        ...
        Sql = " if(object_id('tempdb..#Temp') is not null) begin drop table #Temp end; " & vbCrLf &
              ...
              "             AND ApuracaoDeCustos.Mes_Id             = '" & pMes & "'" & vbCrLf &
              "             And left(ApuracaoDeCustos.Empresa_ID,8) = '" & Left(Empresa(0), 8) & "'     " & vbCrLf &
              "             AND Not ApuracaoDeCustos.CodigoDeCusto_Id In (402, 404, 405)    " & vbCrLf &
              "    UNION ALL" & vbCrLf &
              "          SELECT ApuracaoDeCustos.Empresa_Id, ApuracaoDeCustos.EndEmpresa_Id,  " & vbCrLf &
              "                 PlanoDeCustos.CreditoMercadoria as Conta_Id, " & vbCrLf &
              "                 case  " & vbCrLf &
