<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="AlterarProdutoNotaGerais.aspx.vb" Inherits="NGS.Web.UI.AlterarProdutoNotaGerais" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngNFGObservacao" runat="server" AsyncPostBackTimeout="5000" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlNFGObservacao" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="HID" runat="server" />
            <div class="titulodiv">
                Alterar Produto Nota Gerais
            </div>
            ...
            <div class="bordagrid">
                <asp:GridView ID="grdNFGProdutos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtFator" Enabled="false" Width="30px"  runat="server" />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
