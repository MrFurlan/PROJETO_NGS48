<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="Finalidades.aspx.vb" Inherits="NGS.Web.UI.Finalidades" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngFinalidades" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlFinalidades" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Finalidades
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" TabIndex="1" runat="server" Width="100px" data-ToolTip="default"
                        ToolTip="Número de  cadastro  das finalidades" />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
            ...
            <div class="bordagrid">
                <asp:GridView ID="GridFinalidades" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridFinalidades_SelectedIndexChanged">
