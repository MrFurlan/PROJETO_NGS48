...
Public Class Cr_Mercadorias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Mercadorias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Mercadorias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Mercadorias = New Cr_Mercadorias()
        rpt.Site = Me.Site
        Return rpt
    End Function
