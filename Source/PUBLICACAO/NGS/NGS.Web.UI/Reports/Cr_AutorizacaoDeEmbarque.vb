...
Public Class Cr_AutorizacaoDeEmbarque
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cr_AutorizacaoDeEmbarque.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_AutorizacaoDeEmbarque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_AutorizacaoDeEmbarque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_AutorizacaoDeEmbarque = New Cr_AutorizacaoDeEmbarque()
        rpt.Site = Me.Site
        Return rpt
    End Function
