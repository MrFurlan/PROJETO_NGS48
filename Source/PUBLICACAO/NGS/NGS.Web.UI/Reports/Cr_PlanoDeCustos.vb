...
Public Class Cr_PlanoDeCustos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_PlanoDeCustos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_PlanoDeCustos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_PlanoDeCustos = New Cr_PlanoDeCustos()
        rpt.Site = Me.Site
        Return rpt
    End Function
