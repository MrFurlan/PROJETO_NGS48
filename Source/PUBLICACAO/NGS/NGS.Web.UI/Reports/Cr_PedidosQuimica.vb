...
Public Class Cr_PedidosQuimica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_PedidosQuimica.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CPagamento() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCr_PedidosQuimica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_PedidosQuimica = New Cr_PedidosQuimica()
        rpt.Site = Me.Site
        Return rpt
    End Function
