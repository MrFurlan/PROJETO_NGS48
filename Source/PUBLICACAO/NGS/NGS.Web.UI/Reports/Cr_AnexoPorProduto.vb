...
Public Class Cr_AnexoPorProduto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_AnexoPorProduto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_AnexoPorProduto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_AnexoPorProduto = New Cr_AnexoPorProduto()
        rpt.Site = Me.Site
        Return rpt
    End Function
