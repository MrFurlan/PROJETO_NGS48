...
Public Class Cr_PlanoDeContas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_PlanoDeContas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Detalhado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCr_PlanoDeContas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_PlanoDeContas = New Cr_PlanoDeContas()
        rpt.Site = Me.Site
        Return rpt
    End Function
