...
Public Class Cr_FaturasDeFrete
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_FaturasDeFrete.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_FaturasDeFrete
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_FaturasDeFrete = New Cr_FaturasDeFrete()
        rpt.Site = Me.Site
        Return rpt
    End Function
