...
Public Class Cr_Procuracao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Procuracao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Procuracao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Procuracao = New Cr_Procuracao()
        rpt.Site = Me.Site
        Return rpt
    End Function
