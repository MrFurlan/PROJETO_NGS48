...
Public Class Cr_LaudoDePesagem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_LaudoDePesagem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_LaudoDePesagem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_LaudoDePesagem = New Cr_LaudoDePesagem()
        rpt.Site = Me.Site
        Return rpt
    End Function
