...
Public Class Cr_Comparativo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Comparativo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Comparativo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Comparativo = New Cr_Comparativo()
        rpt.Site = Me.Site
        Return rpt
    End Function
