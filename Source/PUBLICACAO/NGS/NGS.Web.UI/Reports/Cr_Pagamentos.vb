...
Public Class Cr_Pagamentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Pagamentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Pagamentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Pagamentos = New Cr_Pagamentos()
        rpt.Site = Me.Site
        Return rpt
    End Function
