...
Public Class Cr_CustoMedio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_CustoMedio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_CustoMedio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_CustoMedio = New Cr_CustoMedio()
        rpt.Site = Me.Site
        Return rpt
    End Function
