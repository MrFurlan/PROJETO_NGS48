...
Public Class Cr_TiposDeVeiculos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_TiposDeVeiculos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_TiposDeVeiculos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_TiposDeVeiculos = New Cr_TiposDeVeiculos()
        rpt.Site = Me.Site
        Return rpt
    End Function
