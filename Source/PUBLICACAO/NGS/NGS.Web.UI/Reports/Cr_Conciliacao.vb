...
Public Class Cr_Conciliacao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Conciliacao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Conciliacao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Conciliacao = New Cr_Conciliacao()
        rpt.Site = Me.Site
        Return rpt
    End Function
