...
Public Class Cr_VendasPorPedido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_VendasPorPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_VendasPorPedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_VendasPorPedido = New Cr_VendasPorPedido()
        rpt.Site = Me.Site
        Return rpt
    End Function
