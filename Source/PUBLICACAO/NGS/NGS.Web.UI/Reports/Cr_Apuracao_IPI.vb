...
Public Class Cr_Apuracao_IPI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Apuracao_IPI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Apuracao_IPI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Apuracao_IPI = New Cr_Apuracao_IPI()
        rpt.Site = Me.Site
        Return rpt
    End Function
