...
Public Class Cr_CodigoFiscal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_CodigoFiscal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_CodigoFiscal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_CodigoFiscal = New Cr_CodigoFiscal()
        rpt.Site = Me.Site
        Return rpt
    End Function
