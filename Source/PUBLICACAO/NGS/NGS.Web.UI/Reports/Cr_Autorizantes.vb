...
Public Class Cr_Autorizantes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Autorizantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Autorizantes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Autorizantes = New Cr_Autorizantes()
        rpt.Site = Me.Site
        Return rpt
    End Function
