...
Public Class Cr_SinteseDoFluxo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_SinteseDoFluxo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_SinteseDoFluxo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_SinteseDoFluxo = New Cr_SinteseDoFluxo()
        rpt.Site = Me.Site
        Return rpt
    End Function
