...
Public Class Cr_Impressoras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Impressoras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Impressoras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Impressoras = New Cr_Impressoras()
        rpt.Site = Me.Site
        Return rpt
    End Function
