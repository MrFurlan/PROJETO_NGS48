...
Public Class Cr_ApuracaoIcms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_ApuracaoIcms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ApuracaoIcms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ApuracaoIcms = New Cr_ApuracaoIcms()
        rpt.Site = Me.Site
        Return rpt
    End Function
