...
Public Class Cr_Faturamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Faturamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Faturamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Faturamento = New Cr_Faturamento()
        rpt.Site = Me.Site
        Return rpt
    End Function
