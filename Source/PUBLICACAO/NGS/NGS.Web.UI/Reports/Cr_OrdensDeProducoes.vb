...
Public Class Cr_OrdensDeProducoes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cr_OrdensDeProducoes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_OrdensDeProducoes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OrdensDeProducoes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OrdensDeProducoes = New Cr_OrdensDeProducoes()
        rpt.Site = Me.Site
        Return rpt
    End Function
