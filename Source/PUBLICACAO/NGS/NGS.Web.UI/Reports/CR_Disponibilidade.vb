...
Public Class CR_Disponibilidade
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.CR_Disponibilidade.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CR_DispPodPed_ESTOQUE() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCR_Disponibilidade
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Disponibilidade = New CR_Disponibilidade()
        rpt.Site = Me.Site
        Return rpt
    End Function
