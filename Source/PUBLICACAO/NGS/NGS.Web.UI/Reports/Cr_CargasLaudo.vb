...
Public Class Cr_CargasLaudo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_CargasLaudo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_CargasLaudo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_CargasLaudo = New Cr_CargasLaudo()
        rpt.Site = Me.Site
        Return rpt
    End Function
