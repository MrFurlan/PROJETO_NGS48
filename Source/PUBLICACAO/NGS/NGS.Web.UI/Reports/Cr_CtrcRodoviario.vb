...
Public Class Cr_CtrcRodoviario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_CtrcRodoviario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_CtrcRodoviario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_CtrcRodoviario = New Cr_CtrcRodoviario()
        rpt.Site = Me.Site
        Return rpt
    End Function
