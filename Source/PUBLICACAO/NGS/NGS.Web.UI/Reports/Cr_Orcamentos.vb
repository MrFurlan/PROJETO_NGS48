...
Public Class Cr_Orcamentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Orcamentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Exercicio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCr_Orcamentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Orcamentos = New Cr_Orcamentos()
        rpt.Site = Me.Site
        Return rpt
    End Function
