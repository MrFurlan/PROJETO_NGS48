...
Public Class cr_EspelhoNota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.cr_EspelhoNota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_EspelhoNota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_EspelhoNota = New cr_EspelhoNota()
        rpt.Site = Me.Site
        Return rpt
    End Function
