...
Public Class Cr_Liberacoes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Liberacoes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Liberacoes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Liberacoes = New Cr_Liberacoes()
        rpt.Site = Me.Site
        Return rpt
    End Function
