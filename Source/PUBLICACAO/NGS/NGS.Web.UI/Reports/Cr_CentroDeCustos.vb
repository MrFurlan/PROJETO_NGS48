...
Public Class Cr_CentroDeCustos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_CentroDeCustos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_CentroDeCustos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_CentroDeCustos = New Cr_CentroDeCustos()
        rpt.Site = Me.Site
        Return rpt
    End Function
