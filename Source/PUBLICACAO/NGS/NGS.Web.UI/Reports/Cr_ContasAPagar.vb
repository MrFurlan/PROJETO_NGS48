...
Public Class Cr_ContasAPagar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_ContasAPagar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ContasAPagar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ContasAPagar = New Cr_ContasAPagar()
        rpt.Site = Me.Site
        Return rpt
    End Function
