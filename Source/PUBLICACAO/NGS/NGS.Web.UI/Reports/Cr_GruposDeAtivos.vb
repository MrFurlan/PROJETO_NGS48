...
Public Class Cr_GruposDeAtivos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_GruposDeAtivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_GruposDeAtivos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_GruposDeAtivos = New Cr_GruposDeAtivos()
        rpt.Site = Me.Site
        Return rpt
    End Function
