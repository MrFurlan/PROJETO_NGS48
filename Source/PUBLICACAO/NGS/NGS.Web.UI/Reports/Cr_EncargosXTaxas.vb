...
Public Class Cr_EncargosXTaxas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_EncargosXTaxas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_EncargosXTaxas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_EncargosXTaxas = New Cr_EncargosXTaxas()
        rpt.Site = Me.Site
        Return rpt
    End Function
