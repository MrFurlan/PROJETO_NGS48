...
Public Class Cr_Procuracoes2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Procuracoes2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Procuracoes2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Procuracoes2 = New Cr_Procuracoes2()
        rpt.Site = Me.Site
        Return rpt
    End Function
