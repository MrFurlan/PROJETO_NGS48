...
Public Class Cr_PosicaoDeEncargosPorClientes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cr_PosicaoDeEncargosPorClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_PosicaoDeEncargosPorClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TodosEncargo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCr_PosicaoDeEncargosPorClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_PosicaoDeEncargosPorClientes = New Cr_PosicaoDeEncargosPorClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
