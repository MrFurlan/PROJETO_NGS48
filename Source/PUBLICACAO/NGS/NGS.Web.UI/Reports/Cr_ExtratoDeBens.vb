...
Public Class Cr_ExtratoDeBens
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_ExtratoDeBens.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ExtratoDeBens
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ExtratoDeBens = New Cr_ExtratoDeBens()
        rpt.Site = Me.Site
        Return rpt
    End Function
