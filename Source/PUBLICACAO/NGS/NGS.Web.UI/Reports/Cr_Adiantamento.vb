...
Public Class Cr_Adiantamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Adiantamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Adiantamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Adiantamento = New Cr_Adiantamento()
        rpt.Site = Me.Site
        Return rpt
    End Function
