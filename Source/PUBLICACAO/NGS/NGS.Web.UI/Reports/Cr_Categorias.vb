...
Public Class Cr_Categorias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Categorias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Categorias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Categorias = New Cr_Categorias()
        rpt.Site = Me.Site
        Return rpt
    End Function
