...
Public Class Cr_SUbOperacoes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_SUbOperacoes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_SUbOperacoes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_SUbOperacoes = New Cr_SUbOperacoes()
        rpt.Site = Me.Site
        Return rpt
    End Function
