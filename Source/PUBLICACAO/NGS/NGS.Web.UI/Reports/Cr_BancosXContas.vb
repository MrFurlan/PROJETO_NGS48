...
Public Class Cr_BancosXContas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_BancosXContas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_BancosXContas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_BancosXContas = New Cr_BancosXContas()
        rpt.Site = Me.Site
        Return rpt
    End Function
