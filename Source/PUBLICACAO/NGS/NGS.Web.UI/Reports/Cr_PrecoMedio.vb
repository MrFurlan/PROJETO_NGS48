...
Public Class Cr_PrecoMedio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_PrecoMedio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_PrecoMedio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_PrecoMedio = New Cr_PrecoMedio()
        rpt.Site = Me.Site
        Return rpt
    End Function
