...
Public Class Cr_AtivosXBaixas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_AtivosXBaixas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VerificaReemissao() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCr_AtivosXBaixas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_AtivosXBaixas = New Cr_AtivosXBaixas()
        rpt.Site = Me.Site
        Return rpt
    End Function
