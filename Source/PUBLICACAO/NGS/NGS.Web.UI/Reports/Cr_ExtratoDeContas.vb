...
Public Class Cr_ExtratoDeContas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_ExtratoDeContas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ExtratoDeContas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ExtratoDeContas = New Cr_ExtratoDeContas()
        rpt.Site = Me.Site
        Return rpt
    End Function
