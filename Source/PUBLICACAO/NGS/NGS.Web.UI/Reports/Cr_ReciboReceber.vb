...
Public Class Cr_ReciboReceber
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_ReciboReceber.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_XNome() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCr_ReciboReceber
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ReciboReceber = New Cr_ReciboReceber()
        rpt.Site = Me.Site
        Return rpt
    End Function
