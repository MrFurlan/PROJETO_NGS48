...
Public Class Cr_Solicitacoes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_Solicitacoes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_Solicitacoes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_Solicitacoes = New Cr_Solicitacoes()
        rpt.Site = Me.Site
        Return rpt
    End Function
