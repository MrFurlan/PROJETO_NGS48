...
Public Class Cr_ReciboPagar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_ReciboPagar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ReciboPagar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ReciboPagar = New Cr_ReciboPagar()
        rpt.Site = Me.Site
        Return rpt
    End Function
