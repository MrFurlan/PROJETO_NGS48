...
Public Class Cr_PesosDeChegada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_PesosDeChegada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_PesosDeChegada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_PesosDeChegada = New Cr_PesosDeChegada()
        rpt.Site = Me.Site
        Return rpt
    End Function
