...
Public Class Cr_PrecoDeMercado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NGS.Web.UI.Cr_PrecoDeMercado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_PrecoDeMercado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_PrecoDeMercado = New Cr_PrecoDeMercado()
        rpt.Site = Me.Site
        Return rpt
    End Function
