<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="PedidosPendentesDeVendas.aspx.vb" Inherits="NGS.Web.UI.PedidosPendentesDeVendas" %>
    ...
    <asp:UpdatePanel ID="updpnlPedidosPendentesDeVendas" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:DropDownList ID="ddlMes" runat="server" Width="120px" data-ToolTip="default"
                        ToolTip="Mês  para consulta." />
                </div>
                <div class="collbl">
                    De:
                </div>
                <div class="coltxt">
                    <asp:DropDownList ID="ddlAno" runat="server" Width="72px" data-ToolTip="default"
                        ToolTip="Ano para consluta." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:Button ID="cmdCliente" OnClick="cmdCliente_Click" runat="server" CssClass="btn"
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:RadioButton ID="RadCliente" runat="server" Text=" Por Cliente " GroupName="Visualizar"
                        Checked="True" AutoPostBack="True" data-ToolTip="default" ToolTip="Selecionar o modo de visualização." />
                </div>
                <div class="coltxt">
                    <asp:RadioButton ID="RadProduto" runat="server" Text=" Por Produto " GroupName="Visualizar"
                        AutoPostBack="True" data-ToolTip="default" ToolTip="Selecionar o modo de visualização." />
                </div>
            </div>
