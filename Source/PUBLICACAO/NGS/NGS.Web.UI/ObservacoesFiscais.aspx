<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="ObservacoesFiscais.aspx.vb" Inherits="NGS.Web.UI.ObservacoesFiscais" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngObservacoesFiscais" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlObservacoesFiscais" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Observações Fiscais
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" TabIndex="1" runat="server" Width="100px" data-ToolTip="default"
                        ToolTip="Código de cadastro de observação fiscal." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
            ...
            <div class="bordagrid">
                <asp:GridView ID="GridObservacoesFiscais" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridObservacoesFiscais_SelectedIndexChanged">
