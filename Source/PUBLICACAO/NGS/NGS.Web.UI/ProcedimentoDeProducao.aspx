<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master" CodeBehind="ProcedimentoDeProducao.aspx.vb" Inherits="NGS.Web.UI.ProcedimentoDeProducao" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmngProcedimentoDeProducao" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlProcedimentoDeProducao" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Procedimento de Producão
            </div>
                    ...
                    <ul>
                        ...
                        <li runat="server">
                            <asp:LinkButton class="iconExcluir" ID="lnkExcluir" Text="Excluir" runat="server"
                                OnClientClick="if(!confirm('Deseja realmente excluir esse Procedimento?')) return false;" />
                        </li>
                        <li runat="server">
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" runat="server" Enabled="false" data-ToolTip="default"
                        ToolTip="Número do Procedimento." />
                </div>
                <div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" runat="server" Width="500px"
                        data-ToolTip="default" ToolTip="Descrição do Procedimento." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="gridProcedimentoDeProducao" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="gridProcedimentoDeProducao_SelectedIndexChanged">
