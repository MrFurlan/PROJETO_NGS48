<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="CCeModalidadeDeFrete.aspx.vb" Inherits="NGS.Web.UI.CCeModalidadeDeFrete" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngCCeModalidadeDeFrete" runat="server" AsyncPostBackTimeout="5000" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlCCeModalidadeDeFrete" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="HID" runat="server" />
            <div class="titulodiv">
                CCe Modalidade de Frete (NFe)
            </div>
            ...
            <div class="row">
                <div class="coltxt">
                    <asp:RadioButton ID="rdCif" runat="server" Text="CIF" GroupName="ES" />
                </div>
            </div>
            <div class="row">
                <div class="coltxt">
                    <asp:RadioButton ID="rdFOB" runat="server" Text="FOB" GroupName="ES" />
                </div>
            </div>
            <div class="row">
                <div class="coltxt">
                    <asp:RadioButton ID="rdTER" runat="server" Text="Terceiros" GroupName="ES" />
                </div>
            </div>
            <div class="row">
                <div class="coltxt">
                    <asp:RadioButton ID="rdNenhum" runat="server" Text="NEN - Nenhum" GroupName="ES" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
