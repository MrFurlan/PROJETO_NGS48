<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="AlterarEncargoCTE.aspx.vb" Inherits="NGS.Web.UI.AlterarEncargoCTE" %>
            ...
            <div class="bordagrid" style="height: 150px;">
                <asp:GridView ID="gridItens" runat="server" Width="100%" ForeColor="#333333" OnSelectedIndexChanged="gridItens_SelectedIndexChanged" GridLines="None" CellPadding="4" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="QuantidadeFisica" HeaderText="Qtde. Física">
                            <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="QuantidadeFiscal" HeaderText="Qtde. Fiscal">
                            <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                        </asp:BoundField>
