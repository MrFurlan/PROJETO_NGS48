<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="Marcas.aspx.vb" Inherits="NGS.Web.UI.Marcas" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngMarcas" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlMarcas" runat="server">
        <ContentTemplate>
            ...
            <div class="bordagrid" style="max-height: 450px;">
                <asp:GridView ID="GridMarcas" runat="server" AutoGenerateColumns="False" 
                    ...
                    OnSelectedIndexChanged="GridMarcas_SelectedIndexChanged">
