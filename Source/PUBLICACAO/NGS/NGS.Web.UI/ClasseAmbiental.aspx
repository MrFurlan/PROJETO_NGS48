<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="ClasseAmbiental.aspx.vb" Inherits="NGS.Web.UI.ClasseAmbiental" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmngClasseAmbiental" runat="server">
    </asp:ScriptManager>
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlClasseAmbiental" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Classe Ambiental
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" runat="server" Width="500px" data-ToolTip="default" ToolTip="Descrição da periculosidade no ambiente." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="gridClasseAmbiental" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="gridClasseAmbiental_SelectedIndexChanged">
