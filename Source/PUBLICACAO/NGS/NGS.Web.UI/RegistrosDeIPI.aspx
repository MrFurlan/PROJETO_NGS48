<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="RegistrosDeIPI.aspx.vb" Inherits="NGS.Web.UI.RegistrosDeIPI" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngRegistrosDeIPI" runat="server" AsyncPostBackTimeout="900" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlRegistrosDeIPI" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="HID" runat="server" />
            <div class="titulodiv">
                Registros Fiscais IPI
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:CheckBox ID="CkConsNotasCompServicos" runat="server" Text="Considerar Notas Compostas Serviço"
                        BorderStyle="None" Checked="True" data-ToolTip="default" ToolTip="" />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
            ...
            <div class="bordagrid">
                <asp:GridView ID="GridOpcoes" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridOpcoes_SelectedIndexChanged">
    ...
    <uc:RegistrosIpiAjustaResumo ID="ucRegistrosIpiAjustaResumo" runat="server" />
</asp:Content>
