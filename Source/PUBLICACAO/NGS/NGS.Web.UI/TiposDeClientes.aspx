<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="TiposDeClientes.aspx.vb" Inherits="NGS.Web.UI.TiposDeClientes" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngTiposDePessoas" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlTiposDePessoas" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Tipos de Clientes
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" TabIndex="1" runat="server" Width="100px" data-ToolTip="default"
                        ToolTip="Código de cadastro do tipo de cliente." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" TabIndex="2" runat="server" Width="500px" data-ToolTip="default"
                        ToolTip="Descrição do tipo de cliente." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="GridTiposDeClientes" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnPreRender="GridTiposDeClientes_PreRender"
                    OnSelectedIndexChanged="GridTiposDeClientes_SelectedIndexChanged">
