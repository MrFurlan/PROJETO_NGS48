<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="RotinasDeImpressao.aspx.vb" Inherits="NGS.Web.UI.RotinasDeImpressao" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngRotinasDeImpressao" runat="server">
    </asp:ScriptManager>
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlRotinasDeImpressao" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtRotina" TabIndex="1" runat="server" Width="500px" />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
            ...
            <div class="bordagrid">
                <asp:GridView ID="GridRotinasDeImpressao" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridRotinasDeImpressao_SelectedIndexChanged">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Rotina" HeaderText="Rotina">
                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
