<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="AlterarFinalidadeNotaFiscal.aspx.vb" Inherits="NGS.Web.UI.AlterarFinalidadeNotaFiscal" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmAlterarFinalidadeNotaFiscal" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlAlterarFinalidadeNotaFiscal" runat="server">
        <ContentTemplate>
            <asp:HiddenField ID="HID" runat="server" />
            <div class="titulodiv">
                Alterar Finalidade Nota Fiscal
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:DropDownList ID="ddlEmpresa" runat="server" Width="633px" data-ToolTip="default"
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtUf" runat="server" Width="100px" MaxLength="2" data-ToolTip="default"
                        ToolTip="Período inicial da pesquisa." />
                </div>
                <div class="collbl">
                    Data Inicial:
                </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtNota" Style="text-align: right;" runat="server" class="txtNumerico"
                        Width="100px" data-ToolTip="default" ToolTip="Série da Nota Fiscal." />
                </div>
                <div class="collbl">
                    Série:
                </div>
            ...
            <div class="row" id="divDatas" runat="server" visible="False">
                ...
                <div class="coltxt">
                    <asp:DropDownList ID="ddlFinalidade" runat="server" data-ToolTip="default" ToolTip="" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
