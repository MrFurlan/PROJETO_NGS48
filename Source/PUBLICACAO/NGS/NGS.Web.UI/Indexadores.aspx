<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="Indexadores.aspx.vb" Inherits="NGS.Web.UI.Indexadores" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngIndexadores" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlIndexadores" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Indexadores
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" CssClass="txtNumerico" TabIndex="1" runat="server" Width="100px"
                        data-ToolTip="default" ToolTip="Código de cadastro do indexador." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:DropDownList ID="ddlMoeda" runat="server" Width="130px" />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" TabIndex="2" runat="server" Width="500px" data-ToolTip="default"
                        ToolTip="Descrição do indexador." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="GridIndexadores" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GridIndexadores_SelectedIndexChanged">
