<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="FormulacaoDoFito.aspx.vb" Inherits="NGS.Web.UI.FormulacaoDoFito" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scrmngFormulacaoFito" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlFormulacaoFito" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
                Formulação do Fito
            </div>
            ...
            <div class="row">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtCodigo" runat="server" data-ToolTip="default"
                        ToolTip="Número de cadastro da formulação do fito." />
                </div>
            </div>
            <div class="row">
                <div class="collbl">
                ...
                <div class="coltxt">
                    <asp:TextBox ID="txtDescricao" runat="server" Width="500px"
                        data-ToolTip="default" ToolTip="Descrição da formulação do fito." />
                </div>
            </div>
            <div class="bordagrid">
                <asp:GridView ID="gridFormulacaoFito" runat="server" AutoGenerateColumns="False"
                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="gridFormulacaoFito_SelectedIndexChanged">
