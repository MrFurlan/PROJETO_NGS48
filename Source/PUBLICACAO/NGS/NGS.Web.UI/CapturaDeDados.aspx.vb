...
Public Class CapturaDeDados
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack And IsConnect Then
            If Funcoes.VerificaPermissao("CapturaDeDados", "ACESSAR") Then
                If (Left(Session("ssEmpresa"), 8) = "05366261" Or
                    Left(Session("ssEmpresa"), 8) = "24450490" Or
                    Left(Session("ssEmpresa"), 8) = "38198213" Or
                    Left(Session("ssEmpresa"), 8) = "44005444" Or
                    Left(Session("ssEmpresa"), 8) = "48984539" Or
                    Left(Session("ssEmpresa"), 8) = "44979506" Or
                    Left(Session("ssEmpresa"), 8) = "53267147" Or
                    Left(Session("ssEmpresa"), 8) = "62747840" Or
                    Left(Session("ssEmpresa"), 8) = "62780383" Or
                    Left(Session("ssEmpresa"), 8) = "63358210" Or
                    Left(Session("ssEmpresa"), 8) = "24450490") Then
                    ...
                    For Mes As Integer = DdlMesInicial.SelectedValue To DdlMesFinal.SelectedValue
                        ...
                        Else
                            If Left(Empresa(0), 8) = "05272759" _
                                ...
                                OrElse Left(Empresa(0), 8) = "24450490" _
                                OrElse Left(Empresa(0), 8) = "38198213" _
                                OrElse Left(Empresa(0), 8) = "44005444" _
                                OrElse Left(Empresa(0), 8) = "48984539" _
                                OrElse Left(Empresa(0), 8) = "44979506" _
                                OrElse Left(Empresa(0), 8) = "53267147" _
                                OrElse Left(Empresa(0), 8) = "62747840" _
                                OrElse Left(Empresa(0), 8) = "62780383" _
                                OrElse Left(Empresa(0), 8) = "63358210" _
                                OrElse Left(Empresa(0), 8) = "24450490" Then
                ...
                Try
                    ...
                    For Mes As Integer = DdlMesInicial.SelectedValue To DdlMesFinal.SelectedValue
                        ...
                        If Left(Empresa(0), 8) = "05272759" _
                            ...
                            erroAux = CapturaCustosIndiretos(Mes, 404)
                            If erroAux Then
                        ...
                        If Not Left(Empresa(0), 8) = "05272759" _
                            AndAlso Not Left(Empresa(0), 8) = "05366261" _
                            AndAlso Not Left(Empresa(0), 8) = "53267147" _
                            AndAlso Not Left(Empresa(0), 8) = "62747840" _
                            AndAlso Not Left(Empresa(0), 8) = "62780383" _
                            AndAlso Not Left(Empresa(0), 8) = "63358210" _
                            AndAlso Not Left(Empresa(0), 8) = "24450490" _
                            AndAlso Not Left(Empresa(0), 8) = "38198213" _
                            AndAlso Not Left(Empresa(0), 8) = "44005444" _
                            AndAlso Not Left(Empresa(0), 8) = "48984539" _
                            AndAlso Not Left(Empresa(0), 8) = "44979506" _
                            AndAlso Not Left(Empresa(0), 8) = "24450490" Then
                            '****************************************************************************************
                        ...
                        'Tirado a Nutri para fazer a captura de transferencia - 27/01/2025
                        'AndAlso Not Left(Empresa(0), 8) = "05366261" _
                        ...
                        If Not Left(Empresa(0), 8) = "05272759" _
                            ...
                            AndAlso Not Left(Empresa(0), 8) = "62780383" _
                            AndAlso Not Left(Empresa(0), 8) = "63358210" _
                            AndAlso Not Left(Empresa(0), 8) = "62747840" Then
                        ...
                        For ii = 0 To CInt(txtCiclos.Text)
                            ...
                            'erroAux = AjustaMovimentoDevolucaoDeDeposito(Mes)
                            'If erroAux > 0 Then ChkResultado.Items.Add(New ListItem(erroAux & " - Erro(s) durante os ajustes na Devolução de Depósitos"))
    ...
    Private Function AjustaCentavos(ByVal pMes As Integer) As Boolean
        ...
        'Função foi desativada, porque estava apagando dados da 920 para a empresa Verde
        '2025/11/18 - Gilberto - Neri
    ...
    Private Function CapturaCustosIndiretos(ByVal pMes As Integer, Optional codCusto As Integer = 402) As Boolean
        ...
        sql &= "   And  PlanoDeCustosXOrigem.Codigo_Id = " & codCusto & " "
        ...
        For Each rs As DataRow In ds.Tables(0).Rows
            ...
            If Left(Empresa(0), 8) = "05366261" _
                ...
                OrElse Left(Empresa(0), 8) = "44005444" _
                OrElse Left(Empresa(0), 8) = "44979506" _
                OrElse Left(Empresa(0), 8) = "48984539" Then 'Nutri/NutriLog/Baxi/Fronteira/Casbro
            ...
            If dsa IsNot Nothing Then
                If dsa.Tables(0).Rows.Count > 0 Then
                    ...
                    For Each rsb As DataRow In dsb.Tables(0).Rows
                        ...
                        sql &= "                                        And CodigoDeCusto_Id   = " & codCusto & " "
                        ...
                        sql &= "   And Produto_Id         ='" & rsb("Produto_Id") & "'"
                        sql &= "   And ProdutoDerivado_Id =''" '& rs("ProdutoDerivado_Id") & "'"
                        sql &= "   And CodigoDeCusto_Id   = " & codCusto & " " '& rs("Placus_Id")
    ...
    Private Function CapturaNotasFiscais(ByVal pMes As Integer) As Boolean
        ...
        Sql &= "              (EntradaSaida_Id = 'S' AND Devolucao = 'S')) THEN (ValorDoProduto + DespesasAduaneiras + OutrasDespesas) - (ValorCOFINS + ValorPIS + ValorICMS + ValorDescontos) ELSE ValorDoProduto END), 0) AS ValorDoProduto, "
        ...
        Sql &= "                                      NotasFiscais.EntradaSaida_Id, SUM(Enc.ValorIPI) AS ValorIPI, SUM(Enc.ValorICMS) AS ValorICMS, SUM(Enc.ValorDescontos) AS ValorDescontos, SUM(Enc.ValorCOFINS) AS ValorCOFINS,"
        Sql &= "                                      SUM(Enc.ValorPIS) AS ValorPIS, SUM(Enc.DespesasAduaneiras) AS DespesasAduaneiras,SUM(Enc.OutrasDespesas) AS OutrasDespesas, "
        ...
        Sql &= "                                                                      ISNULL(SUM(CASE WHEN UPPER(Encargo_Id) = 'DESP.ADUANEIRAS' THEN NotasFiscaisXEncargos.Valor ELSE 0 END), 0) AS DespesasAduaneiras "
        Sql &= "                                                                      ,ISNULL(SUM(CASE WHEN UPPER(Encargo_Id) IN ('CUSTO ICMS','FRETES')	THEN NotasFiscaisXEncargos.Valor ELSE 0 END), 0) AS OutrasDespesas "
        ...
        Sql &= "                                      NotasFiscaisXItens.EndDepositoTerceiro, SubOperacoes.ApuracaodeCustosContraPartida, NotasFiscais.EntradaSaida_Id, SubOperacoes.Devolucao, Notasfiscais.Finalidade, Notasfiscais.Destino, NotasFiscais.EndDestino)"
        Sql &= "              AS Consulta"
    ...
    Private Function AjustaMovimentoDevolucaoDeDeposito(ByVal pMes As Integer) As Boolean
        ...
        Dim Sql As String = "  Delete ApuracaodeCustos"
        Sql &= " WHERE Left(Empresa_Id, 8) in ('05272759','05366261','53267147','38198213','44005444','48984539','62747840','62780383','63358210')"
        Sql &= " AND (Ano_Id = " & DdlAno.SelectedValue & ")"
        Sql &= " AND (Mes_Id = " & pMes & ")"
    ...
    Private Function AjustaTransferencias(ByVal pMes As Integer) As Boolean
        ...
        Sql &= "    ApuracaoDeCustos.EmpresaDestino_Id,"
        Sql &= "    ApuracaoDeCustos.EndEmpresaDestino_Id,"
    ...
    Sub ContabilizaCustos(ByVal pMes As Integer)
        ...
        If Left(Session("ssEmpresa"), 8) = "44979506" Then
            sql &= "         AND AP.CodigoDeCusto_Id <> 402 "
            sql &= "    UNION   "
            sql &= "		SELECT Razao.Empresa_Id																										"
            sql &= "			,razao.EndEmpresa_Id																									"
            sql &= "			,'' Deposito																											"
            sql &= "			,'' EndDeposito																											"
            sql &= "			,YEAR(Movimento_Id) Ano_Id																								"
            sql &= "			,Month(Movimento_Id) AS Mes_Id																							"
            sql &= "			,'' Produto																												"
            sql &= "			,PlanoDeCustosXOrigem.Codigo_Id																							"
            sql &= "			,PC.Descricao AS TituloDoCusto																							"
            sql &= "			,'101060105' AS DebitoMercadoria																						"
            sql &= "			,CONCAT (																												"
            sql &= "				PlanoDeCustosXOrigem.Conta_Id																						"
            sql &= "				,'99'																												"
            sql &= "				) AS CreditoMercadoria																								"
            sql &= "			,CASE 																													"
            sql &= "				WHEN HM.Descricao <> ''																								"
            sql &= "					THEN HM.Descricao + ' REF: ' + REPLICATE('0', 2 - LEN(convert(VARCHAR, 											"
            sql &= "					Month(Movimento_Id)))) + CONVERT(VARCHAR, Month(Movimento_Id)) + '/' + convert(VARCHAR, YEAR(Movimento_Id))		"
            sql &= "				ELSE PC.Descricao + ' REF: ' + REPLICATE('0', 2 - LEN(convert(VARCHAR, Month(Movimento_Id)))) +						"
            sql &= "				CONVERT(VARCHAR, Month(Movimento_Id)) + '/' + convert(VARCHAR, YEAR(Movimento_Id))									"
            sql &= "				END AS HistoricoMercadoria																							"
            sql &= "			,'' AS DebitoFrete																										"
            sql &= "			,'' AS CreditoFrete																										"
            sql &= "			,CASE 																													"
            sql &= "				WHEN HF.Descricao <> ''																								"
            sql &= "					THEN HF.Descricao + ' REF: ' + REPLICATE('0', 2 - LEN(convert(VARCHAR, Month(Movimento_Id)))) 					"
            sql &= "					+ CONVERT(VARCHAR, Month(Movimento_Id)) + '/' + convert(VARCHAR, YEAR(Movimento_Id))							"
            sql &= "				ELSE PC.Descricao + ' REF: ' + REPLICATE('0', 2 - LEN(convert(VARCHAR, Month(Movimento_Id)))) 						"
            sql &= "				+ CONVERT(VARCHAR, Month(Movimento_Id)) + '/' + convert(VARCHAR, YEAR(Movimento_Id))								"
            sql &= "				END AS HistoricoFrete																								"
            sql &= "			,'' EmpresaDestino_Id																									"
            sql &= "			,0 EndEmpresaDestino_Id																									"
            sql &= "			,'' DepositoDestino_Id																									"
            sql &= "			,0 EndDepositoDestino_Id																								"
            sql &= "			,'' ProdutoDerivado_Id																									"
            sql &= "			,0 Quantidade																											"
            sql &= "			,SUM(Razao.DebitoOficial - Razao.CreditoOficial) AS ValorDoProduto														"
            sql &= "			,0 AS ValorDoFrete																										"
            sql &= "		FROM Razao																													"
            sql &= "		INNER JOIN PlanoDeCustosXOrigem ON LEFT(Razao.Conta_Id, 7) = PlanoDeCustosXOrigem.Conta_Id									"
            sql &= "		INNER JOIN PlanoDeCustos AS PC ON PlanoDeCustosXOrigem.Codigo_Id = PC.Codigo_Id												"
            ...
            sql &= "		WHERE Razao.Empresa_Id LIKE '" & Left(Empresa(0), 8) & "%'																	"
            sql &= "			AND Month(Movimento_Id) = " & pMes & "																					"
            sql &= "			AND YEAR(Movimento_Id) = " & AnoC & "																					"
            sql &= "			AND Lote_Id <> 7000																										"
            sql &= "			AND isnull(PlanoDeCustosXOrigem.Produto, '0') = 0																		"
        ...
        For Each Dr As DataRow In Banco.ConsultaDataSet(sql, "Consulta").Tables(0).Rows
            ...
            If Dr("CodigoDeCusto_Id") = 402 Then
                ...
                sql = "            SELECT	AP.Empresa_Id,
		                                    ...
		                                    AP.ValorDoProduto,
		                                    AP.ValorDoFrete
                                    FROM ApuracaoDeCustos AS AP
                                    INNER JOIN PlanoDeCustos AS PC
                                        ON AP.CodigoDeCusto_Id = PC.Codigo_Id
                                    WHERE 1=1
                                      AND AP.Ano_Id = " & AnoC & "
                                      AND AP.Mes_Id = " & pMes & "
                                      AND (PC.DebitoMercadoria <> '' OR PC.CreditoMercadoria <> '')
                                      AND AP.CodigoDeCusto_Id = 402
                                      AND AP.Empresa_Id = '" & Dr("Empresa_Id") & "' 
                                      AND AP.EndEmpresa_Id = " & Dr("EndEmpresa_Id") & ""

                Dim dsRateioDeProdutos As DataSet = Banco.ConsultaDataSet(sql, "ApuracaoDeCustos")
                Dim valorProduto As Decimal = Convert.ToDecimal(Dr("ValorDoProduto"))

                If dsRateioDeProdutos.Tables(0).Rows.Count > 0 Then

                    ' ===== RATEIO SIMPLIFICADO COM FECHAMENTO DO DELTA =====
                    Dim dtRateio As DataTable = dsRateioDeProdutos.Tables(0)

                    ' 1) totalBase = SUM(ABS(ValorDoProduto))
                    Dim totalBaseAbs As Decimal = 0D
                    For Each r As DataRow In dtRateio.Rows
                        totalBaseAbs += Math.Abs(Convert.ToDecimal(r("ValorDoProduto")))
                    Next

                    If totalBaseAbs = 0D Then
                        CallLancamentos(Dr, Dia, i, Array, valorProduto)
                    Else
                        ' 2) monta partes (Bruto, Arred, Diff inicial)
                        Dim listaDeProdutosParaRateio As New List(Of RateioDeCusto)
                        For Each DrRateio As DataRow In dtRateio.Rows

                            Dim baseAbs As Decimal = Math.Abs(Convert.ToDecimal(DrRateio("ValorDoProduto")))
                            Dim bruto As Decimal = (valorProduto * baseAbs) / totalBaseAbs ' carrega o sinal do total
                            Dim arred As Decimal = Math.Round(bruto, 2, MidpointRounding.AwayFromZero)
                            Dim diff As Decimal = bruto - arred 'Diff é a diferença entre o valor teórico e o valor arredondado.

                            listaDeProdutosParaRateio.Add(New RateioDeCusto With {
                                .Produto = DrRateio("Produto_Id"),
                                .Bruto = bruto,
                                .Arred = arred,
                                .Diff = diff
                            })
                        ...
                        ' 3) delta (sobra/falta após arredondar) e fechamento proporcional entre quem teve diferença
                        Dim somaArred As Decimal = 0D
                        For Each p In listaDeProdutosParaRateio : somaArred += p.Arred : Next

                        Dim delta As Decimal = Math.Round(valorProduto - somaArred, 2, MidpointRounding.AwayFromZero)
                        Dim cents As Integer = CInt(Math.Round(Math.Abs(delta) * 100D, 0, MidpointRounding.AwayFromZero))

                        If cents > 0 Then
                            Dim sinal As Decimal = If(delta > 0D, 0.01D, -0.01D)

                            For stepIdx As Integer = 1 To cents
                                Dim escolhido As Integer = -1

                                If delta > 0D Then
                                    ' distribuir +0,01 para quem mais perdeu (maior Diff > 0)
                                    Dim melhor As Decimal = Decimal.MinValue
                                    For j As Integer = 0 To listaDeProdutosParaRateio.Count - 1
                                        Dim d As Decimal = listaDeProdutosParaRateio(j).Bruto - listaDeProdutosParaRateio(j).Arred ' diff atual
                                        If d > 0D AndAlso d > melhor Then
                                            melhor = d : escolhido = j
                                        End If
                                    Next
                                Else
                                    ' retirar -0,01 de quem mais ganhou (menor Diff < 0)
                                    Dim melhor As Decimal = Decimal.MaxValue
                                    For j As Integer = 0 To listaDeProdutosParaRateio.Count - 1
                                        Dim d As Decimal = listaDeProdutosParaRateio(j).Bruto - listaDeProdutosParaRateio(j).Arred ' diff atual
                                        If d < 0D AndAlso d < melhor Then
                                            melhor = d : escolhido = j
                                ...
                                ' fallback: se ninguém tiver diff (raro), usa o maior |diff|
                                If escolhido = -1 Then
                                    Dim melhorAbs As Decimal = -1D
                                    For j As Integer = 0 To listaDeProdutosParaRateio.Count - 1
                                        Dim dAbs As Decimal = Math.Abs(listaDeProdutosParaRateio(j).Bruto - listaDeProdutosParaRateio(j).Arred)
                                        If dAbs > melhorAbs Then
                                            melhorAbs = dAbs : escolhido = j
                                        End If
                                    Next
                                End If

                                ' aplica 1 centavo ao escolhido
                                listaDeProdutosParaRateio(escolhido).Arred = Math.Round(listaDeProdutosParaRateio(escolhido).Arred + sinal, 2, MidpointRounding.AwayFromZero)
                            Next
                        End If

                        ' 4) lança cada parcela já definitiva (sem mutar Dr)
                        For Each parte In listaDeProdutosParaRateio

                            Dim drClone As DataRow = Dr.Table.NewRow()
                            drClone.ItemArray = CType(Dr.ItemArray.Clone(), Object())
                            drClone("Produto_Id") = parte.Produto

                            CallLancamentos(drClone, Dia, i, Array, parte.Arred)
            ...
            Else
                ' Se não for 402, segue o fluxo normal para a linha atual:
                CallLancamentos(Dr, Dia, i, Array, Convert.ToDecimal(Dr("ValorDoProduto")))
            End If
    ...
    ' ===== classe de apoio =====
    Private Class RateioDeCusto
        Public Produto As Object
        Public Bruto As Decimal
        Public Arred As Decimal
        Public Diff As Decimal ' Bruto - Arred
    End Class

    Sub ContabilizaCustos_bkp_20251105(ByVal pMes As Integer)
        Dim AnoC As Integer
        Dim sql As String
        Dim i As Integer
        ...
        For Each Dr As DataRow In Banco.ConsultaDataSet(sql, "Consulta").Tables(0).Rows
            ...
            If Dr("ValorDoProduto") = 15984.96 Then
                Dim t = 3
            End If
            ...
            If Dr("CodigoDeCusto_Id") = 402 Then
                ...
                Dim valorProduto As Decimal = Dr("ValorDoProduto")

                If dsRateioDeProdutos.Tables(0).Rows.Count > 0 Then

                    For Each DrRateio As DataRow In dsRateioDeProdutos.Tables(0).Rows

                        Dim dtRateio As DataTable = dsRateioDeProdutos.Tables(0)
                        Dim totalBase As Decimal = Math.Abs(Convert.ToDecimal(dtRateio.Compute("SUM(ValorDoProduto)", "")))
                        Dim valorProdutoRateio As Decimal = Math.Abs(DrRateio("ValorDoProduto"))
                        Dim valorRateado As Decimal = 0

                        Dim indiceRateio = Math.Round((valorProdutoRateio / totalBase), 4, MidpointRounding.AwayFromZero)
                        valorRateado = Math.Round((Math.Abs(valorProduto) * indiceRateio), 2, MidpointRounding.AwayFromZero)

                        Dr("Produto_Id") = DrRateio("Produto_Id")

                        'Se o valor do produto for negativo, convertemos o valor rateado para negativo
                        If valorProduto < 0 Then
                            valorRateado *= -1
                        End If

                        ' Se for 402, irá fazer rateio, conforme a Apuração do Custo do 402
                        CallLancamentos(Dr, Dia, i, Array, valorRateado)
            ...
            Else
                ...
                ' Se não for 402, segue o fluxo normal para a linha atual:
                CallLancamentos(Dr, Dia, i, Array, Dr("ValorDoProduto"))
    ...
    Private Sub CallLancamentos(ByVal dr As DataRow, ByVal Dia As String, ByRef i As Integer, ByRef Array As ArrayList, ByVal dValorProduto As Decimal)

        Dim sql As String

        If dValorProduto > 0 Then
            i += 1
            sql = SqlRazao(dr("Empresa_Id"), dr("EndEmpresa_Id"), Dia, 7000, i, dr("DebitoMercadoria"), dr("EmpresaDestino_Id"), dr("EndEmpresaDestino_Id"), dr("Produto_Id"), 3, Dia, dValorProduto, 0, 0, 0, dr("HistoricoMercadoria"), 0, "R")
            If sql.Length > 0 Then
                Array.Add(sql)
            End If
            i += 1
            sql = SqlRazao(dr("Empresa_Id"), dr("EndEmpresa_Id"), Dia, 7000, i, dr("CreditoMercadoria"), dr("EmpresaDestino_Id"), dr("EndEmpresaDestino_Id"), dr("Produto_Id"), 3, Dia, 0, dValorProduto, 0, 0, dr("HistoricoMercadoria"), 0, "R")
            If sql.Length > 0 Then
                Array.Add(sql)
            End If
        End If
        ...
        If dValorProduto < 0 Then
            i += 1
            sql = SqlRazao(dr("Empresa_Id"), dr("EndEmpresa_Id"), Dia, 7000, i, dr("DebitoMercadoria"), dr("EmpresaDestino_Id"), dr("EndEmpresaDestino_Id"), dr("Produto_Id"), 3, Dia, 0, (dValorProduto * -1), 0, 0, dr("HistoricoMercadoria"), 0, "R")
            If sql.Length > 0 Then
                Array.Add(sql)
            End If
            i += 1
            sql = SqlRazao(dr("Empresa_Id"), dr("EndEmpresa_Id"), Dia, 7000, i, dr("CreditoMercadoria"), dr("EmpresaDestino_Id"), dr("EndEmpresaDestino_Id"), dr("Produto_Id"), 3, Dia, (dValorProduto * -1), 0, 0, 0, dr("HistoricoMercadoria"), 0, "R")
            If sql.Length > 0 Then
                Array.Add(sql)
            End If
        End If
    ...
    Public Function Transferencias(ByVal pMes As Integer) As Boolean
        ...
        Dim Sql As String = "SELECT NotasFiscais.Empresa_Id, NotasFiscais.EndEmpresa_Id, NotasFiscaisXItens.Deposito AS Deposito_Id, NotasFiscaisXItens.EndDeposito AS EndDeposito_Id," & vbCrLf &
              ...
              "       SUM(NotasFiscaisXItens.PesoFiscal) AS Quantidade," & vbCrLf &
