<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master"
    CodeBehind="TiposDeLancamentos.aspx.vb" Inherits="NGS.Web.UI.TiposDeLancamentos" %>

<asp:Content ID="ScriptContent" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="scmngTiposDeLancamentos" runat="server" />
    <orea:AjaxUpdating ID="ajaxUpdating" runat="server" Text="Aguarde..." />
    <asp:UpdatePanel ID="updpnlTiposDeLancamentos" runat="server">
        <ContentTemplate>
            <div class="titulodiv">
            ...
            <div class="bordagrid">
                <asp:GridView ID="GridTiposDeLancamentos" runat="server" AutoGenerateColumns="False"
                    OnSelectedIndexChanged="GridTiposDeLancamentos_SelectedIndexChanged" CellPadding="4"
